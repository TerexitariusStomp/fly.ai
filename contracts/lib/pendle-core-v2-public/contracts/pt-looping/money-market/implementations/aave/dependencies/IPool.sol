...
interface IPool {
    ...
    event SwapBorrowRateMode(
        address indexed reserve, address indexed user, AaveDataTypes.InterestRateMode interestRateMode
    );
     ...
     * @param collateral The address of the underlying asset used as collateral, to receive as result of the liquidation
     ...
     *   a proportionally amount of the `collateral` plus a bonus to cover market risk
     * @param collateral The address of the underlying asset used as collateral, to receive as result of the liquidation
     * @param debtAsset The address of the underlying borrowed asset to be repaid with the liquidation
     * @param user The address of the borrower getting liquidated
     * @param debtToCover The debt amount of borrowed `asset` the liquidator wants to cover
