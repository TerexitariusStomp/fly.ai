    ...
    ITimelockControllerOptimistic
{
    ...
    function executeBatchBypass(
        ...
        // mark Ready
        if (!($._timestamps[id] == 0)) revert TimelockControllerOptimistic__OperationConflict();
    ...
    function _authorizeUpgrade(address) internal view override {
        if (!(msg.sender == address(this))) revert TimelockControllerOptimistic__UnauthorizedUpgrade();
    }
}
