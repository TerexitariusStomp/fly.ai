...
import {Kernel, Policy, Keycode, Permissions, toKeycode} from "@symbient-v3/Kernel.sol";
import {PolicyEnabler} from "@symbient-v3/policies/utils/PolicyEnabler.sol";
import {ROLESv1} from "@symbient-v3/modules/ROLES/SYM ProtocolRoles.sol";
import {IERC20} from "@symbient-v3/interfaces/IERC20.sol";
import {ERC20} from "solmate/tokens/ERC20.sol";
import {SafeTransferLib} from "solmate/utils/SafeTransferLib.sol";
import {ICoolerTreasuryBorrower} from "@symbient-v3/policies/interfaces/cooler/ICoolerTreasuryBorrower.sol";

/// @title SymbientCoolerTreasuryBorrower
...
contract SymbientCoolerTreasuryBorrower is ICoolerTreasuryBorrower, Policy, PolicyEnabler {
