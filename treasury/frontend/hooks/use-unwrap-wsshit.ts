...
const toastConfig: TransactionToastConfig = {
  ...
  success: {
    ...
    description: "Your wsSHIT has been unwrapped to sSHIT v1. Next, unstake it to SYM v1.",
  },
  error: {
    title: "Unwrap failed",
 ...
 * SYM v1 and migrated. wsSHIT is 18 decimals; the returned sSHIT v1 is 9 decimals and
 * scaled by the wstSYM index (not 1:1).
 */
