...
default_initial_state1 = {  # variable values borrowed from liquidity-symbient-protocol/simulation.ipynb
    "day": 0,
    ...
    "market_demand_supply": MarketDemandSupply(total_supply=.001,
                                               total_demand=-0.008),  # factors, % of SYM supply expected to drive market demand
...
default_initial_soros = {  # variable values borrowed from liquidity-symbient-protocol/simulation.ipynb
    "liq_stables": 21000000,
    "reserves_stables": 170000000,
    "reserves_volatile": 25000000,
    "price": 9.5,
