...
from ..types.primitives import day, SYM
from typing import List
from ..policy.shitbond import generate_shitbond
import numpy as np
def total_value_bond_creation(start_dates,simulation_timesteps:day, bond_tenors,total_face_value:SYM,bond_value_distribution:List=[])->DataFrame:
    ...
    Args:
        ...
        total_face_value (SYM): The total face value of all bonds cated.
...
def periodic_bond_creation(period: day, bond_tenors: List[day], face_value: SYM, simulation_timesteps: day) -> DataFrame:
    ...
    Args:
        ...
        face_value (SYM): The face value that all bonds will have
...
def period_bond_creation_normal_dist(period: day, bond_tenors: List[day], face_value_mu: SYM, face_value_std: SYM, simulation_timesteps: day) -> DataFrame:
    """Creates a signal of bond creations where every number of days (period),
    ...
    Args:
        period (day): The periodic number of days for bond creation
        bond_tenors (List[day]): The tenors for the bonds to create
        face_value_mu (SYM): The average face value of the bonds
        face_value_std (SYM): The standard deviation of the face value of bonds
        simulation_timesteps (day): The number of timesteps the simulation has
