...
def treasury_liq_safety_check(liq_stables_prior,net_flow_bondexpire,safetyratio,day):
    assert (liq_stables_prior+net_flow_bondexpire) > (safetyratio*liq_stables_prior), f"on day {day}, the amount of netflow caused by symbient bond expiration exceeds {safetyratio}*liq_stables, may cause excessive drainage of the liquidity pool"
