...
const API_BASE = import.meta.env.VITE_SYM_UNITS_API_ENDPOINT ?? "https://api-worker.YOUR-SUBDOMAIN.workers.dev";
...
const SPECIES_NAMES: Record<string, string> = {
  drosophila: "D. melanogaster", rat: "R. norvegicus", mouse: "M. musculus",
  ciona: "C. intestinalis", macaque_modha: "M. mulatta (Modha)",
  human: "H. sapiens", celegans_male: "C. elegans (male)",
};
