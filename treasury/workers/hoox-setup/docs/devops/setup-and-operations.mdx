...
description: "CLI-first setup, deploy, secrets, health, and repair runbook for the HOOX Cloudflare® Workers mesh."
---
...
| `D1_INTERNAL_KEY` <!-- gitleaks:allow --> | d1-worker (header check)            | `wrangler secret put` | Optional     | D1 worker API auth                     |
...
CLOUDFLARE_SECRET_STORE_ID <value>
SUBDOMAIN_PREFIX="hoox"

# === INTERNAL AUTH KEYS ===
D1_INTERNAL_KEY <generate-secure-random-string>  # gitleaks:allow
TRADE_INTERNAL_KEY <value>
AGENT_INTERNAL_KEY <value>

# === TELEGRAM ===
TELEGRAM_BOT_TOKEN <value>

# === AI PROVIDERS (optional) ===
AGENT_OPENAI_KEY <value>
AGENT_ANTHROPIC_KEY <value>
AGENT_GOOGLE_KEY <value>

# === EXCHANGE API KEYS (optional) ===
BINANCE_API_KEY <value>
BINANCE_API_SECRET <value>
MEXC_API_KEY <value>
MEXC_API_SECRET <value>
BYBIT_API_KEY <value>
...
wrangler kv:key put --namespace-id=<your-kv-namespace-id> \
...
# Check kill switch
wrangler kv:key get --namespace-id=<your-kv-namespace-id> "trade:kill_switch"
```
...
wrangler kv:key put --namespace-id=<your-kv-namespace-id> "trade:kill_switch" "false"
wrangler kv:key put --namespace-id=<your-kv-namespace-id> "webhook:tradingview:ip_check_enabled" "false"
wrangler kv:key put --namespace-id=<your-kv-namespace-id> "trade:max_daily_drawdown_percent" "10"
```
...
wrangler kv:key put --namespace-id=<your-kv-namespace-id> "trade:kill_switch" "true"
