...
export interface TreasuryPoint { id: number; reserve_usd: number; total_rfv: number; flyai_floor_price?: number; updated_at: number; }
...
export const getTreasuryHistory = () => fetchJson<TreasuryPoint[]>(`${API_BASE}/api/treasury/history`);
...
// Map treasury snapshots to chart points
export function toTreasuryPoints(points: TreasuryPoint[]): any[] {
