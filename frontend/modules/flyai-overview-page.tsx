/**
 * FLYAI Overview Page — live treasury and connectome overview.
...
import { useApi, toTraderSummaries, type Connectome, type Governance, type TreasuryPoint, type Treasury } from "@/lib/flyai-api";
...
export function FlyaiOverviewPage() {
