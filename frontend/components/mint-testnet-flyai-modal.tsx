...
import { useAppWriteContract } from "@/hooks/use-app-write-contract";
...
interface MintTestnetFlyaiModalProps {
  trigger: React.ReactElement;
  token?: TokenName.FLYAI | TokenName.WSTFLYAI;
}

export function MintTestnetFlyaiModal({ trigger, token = TokenName.FLYAI }: MintTestnetFlyaiModalProps) {
