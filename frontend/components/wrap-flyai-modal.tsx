...
import { WRAP_FLOWS, type WrapFlow } from "@/modules/flyai-wrap-flows";

interface WrapFlyaiModalProps {
  isOpen: boolean;
  onClose: () => void;
  flow: WrapFlow;
  inputAmount: string;
...
export function WrapFlyaiModal({
  isOpen,
  onClose,
  flow,
  inputAmount,
  ...
  useEffect(() => {
    ...
    trackTransactionFailed("flyai", analyticsAction, { reason });
  }, [error]);
